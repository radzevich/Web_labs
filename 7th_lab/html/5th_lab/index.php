...
<body>
<form name="year_input" action="index.php" method="post">
    <p>
        Host: </br>
        <input maxlength="25" size="30" name="host">
    </p>
    <p>
        Login: </br>
        <input maxlength="25" size="30" name="login">
    </p>
    <p>
        Pass: </br>
        <input type="password" maxlength="25" size="30" name="password">
    </p>
    <p>
        Database: </br>
        <input maxlength="25" size="30" name="name">
    </p>
...
function print_table_structure($table_name, $column_list, $data_list)
{
    ...
    {
        echo "<td><b>" . $column_info['Field'] . "</b></td>";
    }
    echo "</tr>";
